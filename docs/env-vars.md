...
| `AEGIS_LLM_INPUT_TOKENS_WARN_THR` | Threshold for LLM input tokens to log a warning | 131072              |
...
| `AEGIS_BOT_KPI_CACHE_DIR`  | Directory for osidb-bot KPI cache file    | `~/.config/aegis_ai/osidb_bot_kpi` |
