...
OSIDB_CACHE_DIR = os.getenv("OSIDB_CACHE_DIR", "./osidb_cache")
os.makedirs(OSIDB_CACHE_DIR, exist_ok=True)
...
for impact in FLAWS_WITH_IMPACT:
    ...
    for flaw in flaw_iter:
        ...
        logging.info(f'writing CVE data to "{cache_file}"')
