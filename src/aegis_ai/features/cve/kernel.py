...
RULES_KERNEL_ADDENDUM = """
                ...
                - Kernel-specific metric guidance:
                    ...
                    - Use-after-free or race conditions with privilege escalation: when the advisory or description states that the flaw enables local privilege escalation (not just DoS/crash), use C:H/I:H/A:H — gaining elevated privileges grants full read/write/disrupt capability over user data.
